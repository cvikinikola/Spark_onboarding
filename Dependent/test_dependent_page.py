...
def test_text_match_required_all_fields():
    ...
    form_title = driver.find_element(By.XPATH, '//div[@class="sc-aXZVg sc-eBMEME fcpFyo dVszMr" and contains(text(), "Dependent’s info")]')
    ...
    expected_first_name_placeholder = "Dependent's first name\u2009*"
    expected_last_name_placeholder = "Dependent's last name\u2009*"
    expected_zip_code_placeholder = "Dependent's zip code\u2009*"
    expected_employee_id_placeholder = "Your Employee ID\u2009*"
    expected_date_of_birth_placeholder = "Dependent's date of birth\u2009*"
    assert first_name_label.text == expected_first_name_placeholder
    assert last_name_label.text == expected_last_name_placeholder
    assert zip_code_label.text == expected_zip_code_placeholder
    assert employee_id_label.text == expected_employee_id_placeholder
    assert date_of_birth_label.text == expected_date_of_birth_placeholder
